...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="">
            ...
            <a href="{{ route('stok-keluar.form') }}" class="btn btn-success me-2">Tambah Data</a>
        </div>
        <br>
        <table class="table table-bordered table-striped table-section" id="tabel-laporan">
            ...
            <tbody>
                @php $no = 1; @endphp
                @foreach ($historiStokKeluar->where('tipe','Stok Keluar') as $histori)
                <tr>
                    <td>{{ $no++ }}.</td>
                    <td>{{ $histori ->id }}</td>
        ...
        @foreach ($historiStokKeluar as $histori)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($histori->detailStokKeluar as $stok)
                                <tr>
